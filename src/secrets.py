...
# Google APIs
GOOGLE_APP_ID = '760617802687-gdnfgka1pt8nelh81bh1133urktpuciu.apps.googleusercontent.com'
GOOGLE_APP_SECRET = 'SWVDT7QaO_JGSezChINUv1Kz '
GOOGLE_PLUS_KEY = 'key for using G+ information within the app'
